            ...
            <header className="fixed top-0 left-0 w-full z-50 bg-black">
                <div className="max-w-[1400px] mx-auto px-8 py-4 flex items-center justify-between">
                    <div className="text-white text-xl font-semibold tracking-wide flex"  >
                        <svg
                            className="opacity-100 translate-x-0 transition-all duration-300 ease-in-out" width="89" height="30" viewBox="0 0 119 24" fill="none"
                        >
                        ...
                        {/* <span className="text-navy-bright mx-1">✺</span> */}
                        <svg
                            className="opacity-100 transition-all duration-300 ease-in-out mx-1"
                            width="40"
                            height="40"
                            viewBox="120 0 40 40"
                            fill="none"
                ...
                >
                    <div className="px-8 py-24 lg:px-36 lg:py-32 h-full flex flex-col">
                        ...
                        <div className="flex items-center gap-x-12 mt-12">
                            <div>
                                <p className="text-xs text-navy-bright mb-2">Email</p>
                                <a
                                    href="mailto:hello@akis.studio"
                            ...
                            <div>
                                <p className="text-xs text-navy mb-2">New client</p>
                                <Link
                                    href="/contact"
                                    className="text-white hover:text-white/80 transition-colors"
                                >
