...
//             <div className="my-10 lg:mb-12 lg:mt-8 lg:grid lg:grid-cols-12">

//                 <div className="flex lg:flex-row-reverse justify-between col-start-6 col-end-13">
...
//                 <p className="col-start-1 col-end-4 mt-10 lg:mt-0 text-xs text-gray-500">
